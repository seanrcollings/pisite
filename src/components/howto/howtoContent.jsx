  ...
  return (
    <Content>
      ...
      <h2>
        ...
        project. I hope to update it soon, but just know that it will not result
        in the same setup as the site is currently using
      </h2>
      ...
      <div className="scratch-contaner">
        ...
        <p className="content-grid__paragraph">
          ...
          my app for your Raspberry Pi. It will work just as well to create your
          own website from scratch. If you want to do that, I would reccomend
          referencing{" "}
          <a href="https://github.com/facebook/create-react-app">
            Facebook's instructions{" "}
          </a>{" "}
          on how to start up your own app. You can jump to the{" "}
          <a href="#production">production</a> if you're deploying your own app.
        </p>
      </div>
      ...
      <div className="development-container">
        ...
        <p className="content-grid__paragraph">
          First off, run{" "}
          <code>git clone https://github.com/seanrcollings/PiSite</code> to pull
          down the repository, or go the{" "}
          <a href="https://github.com/seanrcollings/PiSite">GitHub page</a> and
          download it manually. Now cd into the PiSite directory and run{" "}
          <code>npm install</code> (The Node Package Manager should have come
          with the node server). This command will install all the dependancies
          that the Site requires. Running <code>npm start</code> will start of
          the development server which has tons of cool features like live page
          updating!
        </p>
        ...
        <p className="content-grid__paragraph">
          ...
          below. If that's the case, everything is set up correctly and you can
          view the Site by pasting <code>localhost:3000</code> into your
      ...
      <div className="production-container">
        ...
        <section>
          ...
          <p className="content-grid__paragraph">
            ...
            equivalent. Apache is an open source HTTP server that lets you serve
            the pages of your website out onto the internet. To install Apache
          ...
          <p className="content-grid__paragraph">
            With that, you are pretty much ready to serve webpages from your Pi!
            To test if it's working, move into Apache's default location for
            serving files: <code>/var/www/html/</code> and create an index.html
            with some simple content. Now open a browser and type your Pi's IP
            adress into the url bar. It should display whatever content you put
            in that file. If you're using my project as a base, you will also
            need to install <a href="http://flask.pocoo.org/">Flask</a> (a
            Python backend framework) to get the pages serving correctly. I
            reccomend referencing the Flask website's instructions on how to do
            that.
          </p>
        </section>
      </div>
