			...
			<Content>
				...
				<div className = 'install-container'>
					...
					<ul>
						...
						<li><a href = 'http://flask.pocoo.org/'>Flask Backend</a></li>
					</ul>
				</div>
				...
				<div className = 'scratch-contaner'>
					<h2 id = 'scratch'>Starting from Scratch</h2>
						<p className = 'content-grid__paragraph'>
							Keep in mind that the instructions below are just if you want to use my app for your Raspberry Pi. It will work just as well to create your own website from scratch.
							...
							own app. You can jump to the <a href ='#production'>production</a> if you're deploying your own app.
						</p>
				</div>
				...
				<div className = 'development-container'>
					...
					<p className = 'content-grid__paragraph'>
						...
						dependancies that the Site requires. Running <code>npm start</code> will start of the development server which has tons of cool features like live page updating! 
					</p>
					...
					<p className = 'content-grid__paragraph'>
						...
						When you're finished changing things, run <code>npm build</code> and the development files will compile into their static version, ready for deployment.
					</p>
				...
				<div className = 'production-container'>
					...
					<section>
						...
						<p className = 'content-grid__paragraph'>Open a new terminal session and type in this command: </p>
						<div className = 'img-container'>
						...
						<p className = 'content-grid__paragraph'>
							...
							and can interact with it in any way that you could if you actually had the Pi infront of you. I find this an easier way to deal with the Pi because I don't have an entire 
							other setup to attatch to the Pi and I would end up doing most of this from the terminal either way.
						</p>
					</section>
					...
					<section>
						...
						<p className = 'content-grid__paragraph'>
							The first thing you need to do in the Pi, is install Apache or an equivalent. Apache is an open source HTTP server that lets you serve the pages of your website out onto the 
						...
						<p className = 'content-grid__paragraph'>
							...
							display whatever content you put in that file. If you're using my project as a base, you will also need to install <a href='http://flask.pocoo.org/'>Flask</a> (a Python backend framework) 
							to get the pages serving correctly. I reccomend referencing the Flask website's instructions on how to do that. 
						</p>
					</section>
				</div>
			</Content>
