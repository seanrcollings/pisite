...
data_types = [
	...
	DataType('Process Memory', 'The memory usage of the process that is using the most CPU time', "ps -o pid --sort=-pmem | head -n 2 | tr -dc '0-9'") # fixed up some of these commands so they run on the pi
]
